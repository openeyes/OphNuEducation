...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields">
		<?php echo $form->radioButtons($element, 'caregivers_present_id', CHtml::listData(OphNuEducation_CareGivers_CaregiversPresent::model()->findAll(array('order'=>'display_order asc')),'id','name'), null, false, false, false, false, array('class' => 'linked-fields', 'data-linked-fields' => 'relationship_1_name,relationship_1_id,relationship_2_name,relationship_2_id','data-linked-values' => 'Yes'), array('label' => 3, 'field' => 4))?>
