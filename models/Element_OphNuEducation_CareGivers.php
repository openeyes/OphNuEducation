 ...
 * @property OphNuEducation_CareGivers_Relationship $relationship
 * @property OphNuEducation_CareGivers_Relationship $relationship
 */
...
class Element_OphNuEducation_CareGivers  extends  BaseEventTypeElement
{
	...
	{
		return array(
			array('event_id, caregivers_present_id, name, relationship_id, name2, relationship_id, consent_signed, ', 'safe'),
			array('caregivers_present_id, name, relationship_id, name2, relationship_id, consent_signed, ', 'required'),
			array('id, event_id, caregivers_present_id, name, relationship_id, name2, relationship_id, consent_signed, ', 'safe', 'on' => 'search'),
		);
	}
	...
	public function relations()
	{
		return array(
			...
			'relationship' => array(self::BELONGS_TO, 'OphNuEducation_CareGivers_Relationship', 'relationship_id'),
			'relationship' => array(self::BELONGS_TO, 'OphNuEducation_CareGivers_Relationship', 'relationship_id'),
		);
	}
